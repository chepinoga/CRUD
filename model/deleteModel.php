...
{
    $pdo_conn = $pdo_conn = new PDO("mysql:host=127.0.0.1;dbname=CRUD", 'root', '223344');
...
function insert($name,$description, $created_at)
{
    ...
    $sql = 'DELETE FROM article (name, description, created_at) VALUES (:name, :description, :created_at)';
...
function delete($id, $name, $description, $created_at) {
